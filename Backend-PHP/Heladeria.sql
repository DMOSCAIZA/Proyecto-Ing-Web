...
CREATE TABLE ingreso(
	...
	serie_comp varchar(7) NULL,
	num_comp varchar(10) NOT NULL,
...
CREATE TABLE trabajador(
	idtrabajador int auto_increment NOT NULL PRIMARY KEY,
	idrol int NOT NULL,
	nombre varchar(100) NOT NULL,
	tipo_documento varchar(20) NULL,
	num_documento varchar(20) NULL,
...
ALTER TABLE ingreso    ADD FOREIGN KEY(idtrabajador)
REFERENCES  trabajador (idtrabajador);

ALTER TABLE trabajador    ADD FOREIGN KEY(idrol)
REFERENCES  rol (idrol);

ALTER TABLE venta   ADD FOREIGN KEY(idcliente)
REFERENCES  persona (idpersona);

ALTER TABLE venta   ADD FOREIGN KEY(idtrabajador)
REFERENCES  trabajador (idtrabajador);
...
INSERT  venta (idventa, idcliente, idtrabajador, tipo_comp, serie_comp, num_comp, fecha_hora, impuesto, total, estado) VALUES (1, 1, 1, N'FACTURA', N'66798', N'6579', CAST(N'2020-12-10T01:32:24.187' AS DateTime), CAST(18.00 AS Decimal(4, 2)), CAST(1.20 AS Decimal(11, 2)), N'Aceptado');
